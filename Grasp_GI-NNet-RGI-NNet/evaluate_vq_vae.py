...
from train_network_vq_vae_rginnet import Model
...
if __name__ == '__main__':
    ...
    model.load_state_dict(
        torch.load("/home/priya/Grasp_GI-NNet-RGI-NNet/logs/211027_2330_training_cornell_RGINNET_09/epoch_20_iou_vqvae_0.96"))
    ...
    for network in args.network:
        ...
        logging.info(f'Loss :{lossd["loss"]}')
