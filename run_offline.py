...
def parse_args():
    ...
    parser.add_argument('--rgb_path', type=str, default='/home/newgeniedc/Nilotpal/robotic-grasping/testImg/c10.png',
                        help='RGB Image path')
    parser.add_argument('--depth_path', type=str, default='/home/newgeniedc/Nilotpal/robotic-grasping/testImg/depth10.png',
